...
<body>
	<div class="center-outer"><div class="center-middle">
		...
		<div class="center-content battle-ui">
			<div class="ui-left pull-left ff7">
				<button id="fight" class="btn btn-info center-block spring" disabled>Fight</button>
				<button id="run" class="btn btn-primary center-block spring">Run Away</button>
			</div>
			<div class="ui-right pull-left ff7">
...
$(document).ready(function () {
	...
	$("#run").click(function() {
		...
		$("#run").removeClass("btn-primary").addClass("btn-info").prop("disabled", true);
		$("#fight").removeClass("btn-info").addClass("btn-primary").prop("disabled", false);
	});
	$("#fight").click(function() {
		battle.issue("attack");
		$("#fight").removeClass("btn-primary").addClass("btn-info").prop("disabled", true);
		$("#run").removeClass("btn-info").addClass("btn-primary").prop("disabled", false);
	});
